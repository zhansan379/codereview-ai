...
export default {
  'zh-CN': {
    ...
    form: {
      provider: '平台',
      providerPlaceholder: '填入 Web URL 后自动识别',
      providerHint: '平台由 Web URL 自动识别',
      providerTip: {
        how: '填入 Web URL 后失焦即自动识别：公开托管站（github.com / gitlab.com / gitee.com）与常见自建命名（host 含 gitlab / gitea / gitee / github）直接映射。',
        probe: 'host 命名看不出平台时，会探测站点特征 API 路径（Gitea /api/v1/version、GitLab /api/v4/version、GitHub Enterprise /api/v3）。',
        manual: '仍未识别时，在此手动选择平台后点「解析」即可。',
      },
      reviewStrategy: '审查策略',
      ...
      repoFullName: '仓库全名',
      webUrl: 'Web URL',
      webUrlPlaceholder: '粘贴仓库链接即自动识别平台并回填 仓库ID / 仓库全名',
      resolve: '解析',
      branchRule: '分支规则',
  ...
  en: {
    ...
    form: {
      provider: 'Provider',
      providerPlaceholder: 'Auto-detected from the Web URL',
      providerHint: 'Platform auto-detected from the Web URL',
      providerTip: {
        how: 'Detected when the Web URL loses focus: public sites (github.com / gitlab.com / gitee.com) and common self-hosted names (host containing gitlab / gitea / gitee / github) map directly.',
        probe: 'When the host name gives away nothing, well-known API paths are probed (Gitea /api/v1/version, GitLab /api/v4/version, GitHub Enterprise /api/v3).',
        manual: 'If still unrecognized, pick the platform here and click "Resolve".',
      },
      reviewStrategy: 'Review strategy',
      ...
      webUrl: 'Web URL',
      webUrlPlaceholder: 'Paste a repository link to auto-detect the platform and fill Repo ID / Repo full name',
      resolve: 'Resolve',
